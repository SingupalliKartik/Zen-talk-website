...
const Signup = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("http://localhost:3001/kuki", { name, email, password })
      .then((result) => {
        console.log(result);
        ...
        <div className="flex  items-center justify-center   my-5">
          <div className="bg-[#56B7C3] flex  text-center self-stretch px-16 rounded-lg">
            <div className="flex flex-col justify-center   ">
              <p className=" text-white text-3xl my-3">New to us</p>
              <p className="text-white items-center w-36 text-sm">
          ...
          <div className=" bg-[#ffffff] w-1/2  text-center py-12 rounded">
            ...
            <div className="fome px-36  space-y-2 justify-center my-3 flex flex-col items-center">
              ...
              <div className="flex drop-shadow-[-3px_3px_1px_rgba(0,85,73,0.05)] ">
                <img className="w-8 absolute my-4  mx-2" src={emails} alt="" />

                <input
                  className=" bg-[#F9FFFE]  p-4 px-12 rounded w-96"
                  type="email"
                  name="emal"
                  id=""
                  placeholder="Email"
